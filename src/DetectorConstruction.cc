...
G4VPhysicalVolume* DetectorConstruction::ConstructVolumes()
{
  ...
  bw_log->SetSensitiveDetector(DEG);// treat like a degrader
...
G4bool DetectorConstruction::SetTargetMaterial(G4String material)
{
  ...
  else if (material=="NeGas1atm") {
    targetMat = mat->NeGas1atm;
  }
  else if (material=="NeGas05atm") {
    targetMat = mat->NeGas05atm;
  }
  else if (material=="NeGas01atm") {
    targetMat = mat->NeGas01atm;
  }

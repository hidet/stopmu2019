...
fnames = ["mu-_mom27_bite5_Ne1atm_gausbeam",
          "mu-_mom26_bite5_Ne1atm_gausbeam",
          "mu-_mom25_bite5_Ne1atm_gausbeam",
          "mu-_mom24_bite5_Ne1atm_gausbeam",
          "mu-_mom23_bite5_Ne1atm_gausbeam",
          "mu-_mom22_bite5_Ne1atm_gausbeam",
          "mu-_mom21_bite5_Ne1atm_gausbeam",
          "mu-_mom20_bite5_Ne1atm_gausbeam",
          "mu-_mom19_bite5_Ne1atm_gausbeam",
          "mu-_mom18_bite5_Ne1atm_gausbeam",
          "mu-_mom17_bite5_Ne1atm_gausbeam",
          "mu-_mom16_bite5_Ne1atm_gausbeam"]
...
legend.Draw("same")
c1.SaveAs("mu-_stoppos_momdep_Ne1atm_gausbeam.pdf")
...
for i,(f,fname,htg) in enumerate(zip(fs,fnames,htgs)):
    ...
    if i==0:
        ...
        htg.GetYaxis().SetRangeUser(0,2000)
        htg.Draw("hist")
    else:
        htg.Draw("histsame")
    legend.AddEntry(htg.GetName(), fname+" stpr=%.2f"%(ntgstop[i]/1e4), "l");
legend.Draw("same")
c2.SaveAs("mu-_target_stoppos_momdep_Ne1atm_gausbeam.pdf")
